...
public class ObjectIdentifiers {
	...
	public static final OID AGENT_CPU_USAGE_IDENTIFIER = new OID(".1.3.6.1.2.1.2.4.1");
	public static final OID AGENT_MEMORY_USAGE_IDENTIFIER = new OID(".1.3.6.1.2.1.2.5.1");
